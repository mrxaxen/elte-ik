...
public class Graph {
    ...
    public void genPremade() {
        ...
        edges.add(new Edge(nodes.get(0), nodes.get(4), 2));
        //b
        edges.add(new Edge(nodes.get(1), nodes.get(2),6));
        edges.add(new Edge(nodes.get(1), nodes.get(4),2));
        //c
        edges.add(new Edge(nodes.get(2), nodes.get(4),4));
        edges.add(new Edge(nodes.get(2), nodes.get(5),4));
        //d
        edges.add(new Edge(nodes.get(3), nodes.get(4),3));
        //e
        edges.add(new Edge(nodes.get(4), nodes.get(5),5));
        //f
    }
